  ...
  return (
    <div className="h-screen bg-beige/50">
      <div className="container h-full px-6 py-24">
        <div className="flex flex-col mx-auto text-center pt-20">
          <h1 className="text-4xl font-semibold">Don't Have an Account?</h1>
          <small className="text-gray-400 text-lg">
            Sign up with us below!
          </small>
        </div>
        <div className="g-6 flex h-5/6 items-center justify-center lg:justify-between">
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
              ...
              <div className="relative mb-6" data-te-input-wrapper-init>
                <input
                  ...
                  className="block pt-4 pb-1 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
