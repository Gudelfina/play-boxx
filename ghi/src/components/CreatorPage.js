...
export default function CreatorPage() {
  return (
    <>
      ...
      <div className="h-full pt-8 px-8 pb-32 bg-beige mx-auto grid grid-cols-2 grid-flow-row auto-rows-min">
        {/* Angus's Card */}
        ...
        <div className="creator-card mx-auto">
          <div className="max-w-sm rounded overflow-hidden shadow-lg bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <div className="flex flex-col justify-between p-4 leading-normal">
              ...
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                Hello! I am a former healthcare professional turned software
                engineer. I am continuing to hone my problem solving and
                communication skills in order to become a tenacious and
                supportive teammate. My passion is to develop user-focused,
                feature-rich applications that are interactive, intuitive and
                enjoyable!
              </p>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                <span className="font-semibold">Hobbies/Interests:</span>
        ...
        <div className="creator-card mx-auto">
          <div className="max-w-sm rounded overflow-hidden shadow-lg bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <div className="flex flex-col justify-between p-4 leading-normal">
              ...
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                Hi! I am pursuing my software developer dream after coding
                peaked my interest while working with robots at Tesla. I am
                passionate about tying in this new found career with my love for
                remote controlled vehicle and love for learning new things.
              </p>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                <span className="font-semibold">Hobbies/Interests:</span>
                <br />
